...
%   INFO.fnorm is the norm of the employed state-feedback/feedforward used 
%       for dynamic cover computation if OPTIONS.mindeg = true, or for 
%       stabilization of free eigenvalues if OPTION.sdeg is non-empty.  
...
%  Revision(s): A. Varga, 02.11.2016, 07.05.2017, 21.08.2018.
%
